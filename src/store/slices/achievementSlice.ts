  ...
  initializeAchievements: () =>
    set((state) => {
      ...
      const achievements: Achievement[] = [
        ...
        { id: 'pokedex_all', name: 'Professor Pokémon', description: 'Completa tutti i Pokédex', category: 'collection', target: 1025, reward: { coins: 50000, title: 'Professor' }, progress: totalCount, unlocked: false },
        ...
        { id: 'col_gen9', name: 'Esploratore Paldea', description: 'Cattura 30 Pokémon di Gen 9', category: 'collection', target: 30, reward: { coins: 4500, items: { rare_candy: 2 } }, progress: 0, unlocked: false },
        { id: 'col_gen9_full', name: 'Maestro Paldea', description: 'Cattura tutti i 120 Pokémon di Gen 9', category: 'collection', target: 120, reward: { coins: 14000, items: { rare_candy: 4, masterball: 2 } }, progress: 0, unlocked: false },
        {
          id: 'mega_first',
