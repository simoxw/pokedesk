...
import { NATURE_MODS, getNatureLabel } from '../../BattleEngine';
        ...
        {sortedNatures.map((nature) => {
          ...
          return (
            <button
              ...
              title={`${getNatureLabel(nature)}: +10% ${STAT_NAMES[mod.up]}, -10% ${STAT_NAMES[mod.down]}`}
            >
              <span className="font-black">{getNatureLabel(nature)}</span>
